...
export function Footer() {
  ...
  return (
    <footer className="w-full py-12 mt-auto bg-gradient-to-b from-background via-purple-50/30 to-background dark:via-purple-900/10 border-t border-purple-900/10">
      <div className="container px-4 md:px-6">
        ...
        >
          <div className="flex items-center">
            ...
            <span>© 2025 <span className="font-semibold text-purple-600 dark:text-purple-400">Sayvia</span>. All rights reserved.</span>
          </div>
