// src/app/(app)/dashboard/premium/page.tsx
'use client';
    ...
    if (!session?.user?.isPremium) {
        return (
            <motion.div
                ...
                className="text-center mt-20 max-w-md mx-auto p-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-lg border border-gray-200"
            >
                ...
                <p className="mt-4 text-gray-600">
                    Upgrade to unlock powerful features that enhance your feedback experience
                </p>
                <Button className="mt-6 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white shadow-lg">
                    Upgrade Now
                </Button>
            </motion.div>
        );
    ...
    const handleSaveLink = () => {
        ...
        setTimeout(() => {
            toast({
                ...
                description: `Your new link: sayvia.com/${customLink || session.user.username}`,
            });
            setIsSaving(false);
        }, 800);
    };
                        ...
                        <motion.div whileHover={{ y: -5 }}>
                            <Card className="h-full border border-gray-200/70 hover:border-blue-200 transition-all">
                                ...
                                <CardContent className="space-y-2">
                                    ...
                                    >
                                        {isSaving ? "Saving..." : "Save Custom Link"}
                                    </Button>
                                </CardContent>
                                <CardFooter className="text-xs text-gray-500">
